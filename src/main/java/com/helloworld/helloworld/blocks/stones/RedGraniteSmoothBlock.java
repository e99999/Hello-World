...
public class RedGraniteSmoothBlock extends Block {

    //basic information about this block
	public RedGraniteSmoothBlock() {
        super(Material.ROCK);
        setUnlocalizedName(HelloWorld.MODID + ".redgranitesmoothblock");
        setRegistryName("redgranitesmoothblock");
